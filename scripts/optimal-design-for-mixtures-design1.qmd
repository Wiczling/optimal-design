...
chosen_indices = c(209,210,118,87) # initial values
fwstgc_prior_4 = fedorov_wynn_stan_par_tgconstraint(mean_log_det_stan, datastruct_prior_ma, inits, chosen_indices, tg_constraint = 810,n_iter = 100)
chosen_indices = c(79,209,71,210) # initial values
fwstgc_noprior_4 = fedorov_wynn_stan_par_tgconstraint(mean_log_det_stan, datastruct_noprior_ma, inits, chosen_indices, tg_constraint = 810,n_iter = 100)

chosen_indices = c(7,201,210,118,87) # initial values
fwstgc_prior_5 = fedorov_wynn_stan_par_tgconstraint(mean_log_det_stan, datastruct_prior_ma, inits, chosen_indices, tg_constraint = 810,n_iter = 100)
chosen_indices = c(7,124,209, 71,210) # initial values
fwstgc_noprior_5 = fedorov_wynn_stan_par_tgconstraint(mean_log_det_stan, datastruct_noprior_ma, inits, chosen_indices, tg_constraint = 810,n_iter = 100)
```
...
#### tg constrained
```{r single-form-analytes-logDet-summary-tgc}
chosen_indices_prior = c(65,66,209,210) # ref
chosen_indices_noprior= c(65,66,209,210) # ref
fwstgc_prior_ref = fedorov_wynn_stan_par(mean_log_det_stan, datastruct_prior_ma, inits, chosen_indices_prior, n_iter = 0)
fwstgc_noprior_ref = fedorov_wynn_stan_par(mean_log_det_stan, datastruct_noprior_ma, inits, chosen_indices_noprior, n_iter = 0)

chosen_indices_prior   = c(209,212) # p=2
fwstgc_prior_2 = fedorov_wynn_stan_par(mean_log_det_stan, datastruct_prior_ma, inits, chosen_indices_prior, n_iter = 0)

chosen_indices_prior   = c(210,209,79) # p=3
chosen_indices_noprior = c(210,209,79) # p=3
fwstgc_prior_3 = fedorov_wynn_stan_par(mean_log_det_stan, datastruct_prior_ma, inits, chosen_indices_prior, n_iter = 0)
fwstgc_noprior_3 = fedorov_wynn_stan_par(mean_log_det_stan, datastruct_noprior_ma, inits, chosen_indices_noprior, n_iter = 0)

chosen_indices_prior   = c(209,210,118,87) # p=4
chosen_indices_noprior = c(79,209,71,210) # p=4
fwstgc_prior_4 = fedorov_wynn_stan_par(mean_log_det_stan, datastruct_prior_ma, inits, chosen_indices_prior, n_iter = 0)
fwstgc_noprior_4 = fedorov_wynn_stan_par(mean_log_det_stan, datastruct_noprior_ma, inits, chosen_indices_noprior, n_iter = 0)

chosen_indices_prior = c(7,201,210,118,87) # p=5
chosen_indices_noprior = c(7,124,209, 71,210) # p=5
fwstgc_prior_5 = fedorov_wynn_stan_par(mean_log_det_stan, datastruct_prior_ma, inits, chosen_indices_prior, n_iter = 0)
fwstgc_noprior_5 = fedorov_wynn_stan_par(mean_log_det_stan, datastruct_noprior_ma, inits, chosen_indices_noprior, n_iter = 0)

summary_resultstgc = tibble(prior_ref = fwstgc_prior_ref$log_det_FIM,
                          noprior_ref = fwstgc_noprior_ref$log_det_FIM,
                          prior_2 = fwstgc_prior_2$log_det_FIM,
                          prior_3 = fwstgc_prior_3$log_det_FIM,
                          noprior_3 = fwstgc_noprior_3$log_det_FIM,
                          prior_4 = fwstgc_prior_4$log_det_FIM,
                          noprior_4 = fwstgc_noprior_4$log_det_FIM,
                          prior_5 = fwstgc_prior_5$log_det_FIM,
                          noprior_5 = fwstgc_noprior_5$log_det_FIM) %>%
  pivot_longer(prior_ref:noprior_5, names_to = "method")

p1<-ggplot(summary_resultstgc, aes(y=method,x=value))+
  geom_boxplot()+
  labs(x="log(|FIM|)", y = "Method")

summary_results_difftgc = tibble(fws_prior_ref = fwstgc_prior_ref$log_det_FIM,
                          fws_noprior_ref = fwstgc_noprior_ref$log_det_FIM,
                          fws_prior_2 = fwstgc_prior_2$log_det_FIM,
                          fws_prior_3 = fwstgc_prior_3$log_det_FIM,
                          fws_noprior_3 = fwstgc_noprior_3$log_det_FIM,
                          fws_prior_4 = fwstgc_prior_4$log_det_FIM,
                          fws_noprior_4 = fwstgc_noprior_4$log_det_FIM,
                          fws_prior_5 = fwstgc_prior_5$log_det_FIM,
                          fws_noprior_5 = fwstgc_noprior_5$log_det_FIM) %>%
  mutate(d_prior_2 = (fws_prior_2 - fws_prior_ref)/n_param,
         d_prior_3 = (fws_prior_3 - fws_prior_ref)/n_param,
         d_noprior_3 = (fws_noprior_3 - fws_noprior_ref)/n_param,
         d_prior_4 = (fws_prior_4 - fws_prior_ref)/n_param,
...
p2=ggplot(summary_results_difftgc, aes(y=method,x=exp(value)))+
  geom_boxplot()+
  labs(x="Efficiency relative to the reference design", y = "Method")+
  geom_vline(xintercept = 1, linetype = "dotted")

summary_results_diffpriortgc = tibble(fws_prior_ref = fwstgc_prior_ref$log_det_FIM,
                          fws_noprior_ref = fwstgc_noprior_ref$log_det_FIM,
                          fws_prior_3 = fwstgc_prior_3$log_det_FIM,
                          fws_noprior_3 = fwstgc_noprior_3$log_det_FIM,
                          fws_prior_4 = fwstgc_prior_4$log_det_FIM,
...
p3=ggplot(summary_results_diffpriortgc, aes(y=method,x=exp(value)))+
  geom_boxplot()+
  labs(x="Effect of prior on design efficiency", y = "Method")+
  geom_vline(xintercept = 1, linetype = "dotted") +
  scale_x_continuous(limits = c(0.5,100),
...
my.ggsave(.plot=p1, .filename=paste("single-form-analytes-logdFIM-abs-tgc.pdf"), .path = figures_dir1)
my.ggsave.png(.plot=p1, .filename=paste("single-form-analytes-logdFIM-abs-tgc.png"), .path = figures_dir1)
my.ggsave(.plot=p2, .filename=paste("single-form-analytes-logdFIM-rel-tgc.pdf"), .path = figures_dir1)
my.ggsave.png(.plot=p2, .filename=paste("single-form-analytes-logdFIM-rel-tgc.png"), .path = figures_dir1)
my.ggsave(.plot=p3, .filename=paste("single-form-analytes-logdFIM-prioreff-tgc.pdf"), .path = figures_dir1)
my.ggsave.png(.plot=p3, .filename=paste("single-form-analytes-logdFIM-prioreff-tgc.png"), .path = figures_dir1)
```
