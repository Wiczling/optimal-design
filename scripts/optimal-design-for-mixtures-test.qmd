...
thisScript <- "optimal-design-for-mixtures-test-30"
```
...
### Read the results and compare - 90

```{r single-form-analytes-logDet-summary-90}
chosen_indices_prior = c(65,66,209,210) # ref
chosen_indices_noprior= c(65,66,209,210) # ref
fws1_prior_ref = fedorov_wynn_stan_par(mean_log_det_stan, datastruct_prior_ma_2, inits_2, chosen_indices_prior, n_iter = 0)
fws1_noprior_ref = fedorov_wynn_stan_par(mean_log_det_stan, datastruct_noprior_ma_2, inits_2, chosen_indices_noprior, n_iter = 0)
...
fws1_prior_2 = fedorov_wynn_stan_par(mean_log_det_stan, datastruct_prior_ma_2, inits_2, chosen_indices_prior, n_iter = 0)
chosen_indices_prior   = c(209,212) # p=2
...
fws1_prior_3 = fedorov_wynn_stan_par(mean_log_det_stan, datastruct_prior_ma_2, inits_2, chosen_indices_prior, n_iter = 0)
fws1_noprior_3 = fedorov_wynn_stan_par(mean_log_det_stan, datastruct_noprior_ma_2, inits_2, chosen_indices_noprior, n_iter = 0)
chosen_indices_prior   = c(212,209,215) # p=3
chosen_indices_noprior = c(212,209,71) # p=3
...
fws1_prior_4 = fedorov_wynn_stan_par(mean_log_det_stan, datastruct_prior_ma_2, inits_2, chosen_indices_prior, n_iter = 0)
fws1_noprior_4 = fedorov_wynn_stan_par(mean_log_det_stan, datastruct_noprior_ma_2, inits_2, chosen_indices_noprior, n_iter = 0)
chosen_indices_prior   = c(209,212,215,71) # p=4
chosen_indices_noprior = c(209,212,215,71) # p=4
...
fws1_prior_5 = fedorov_wynn_stan_par(mean_log_det_stan, datastruct_prior_ma_2, inits_2, chosen_indices_prior, n_iter = 0)
fws1_noprior_5 = fedorov_wynn_stan_par(mean_log_det_stan, datastruct_noprior_ma_2, inits_3, chosen_indices_noprior, n_iter = 0)
chosen_indices_prior = c(210,209,214,215,79) # p=5
chosen_indices_noprior = c(210,209,216,215,71) # p=5
...
summary_results_diff = tibble(logP = logP2,
                          Type = NAB2,
  ...
  pivot_longer(d1_prior_ref:d1_noprior_5, names_to = "method")

p1=ggplot(summary_results_diff, aes(y=method,x=exp(value)))+
  geom_boxplot(outlier.size = 0.5)+
  geom_jitter(aes(y=method, x=exp(value), color=logP),size=0.5, alpha=0.1)+
  scale_color_continuous(type="viridis")+
  labs(x="Efficiency of designs (optimzed for maxtg = 90 and based on maxtg = 270)", y = "Method")+
  geom_vline(xintercept = 1, linetype = "dotted")
```

### Read the results and compare - 30

```{r single-form-analytes-logDet-summary-30}
chosen_indices_prior = c(65,66,209,210) # ref
chosen_indices_noprior= c(65,66,209,210) # ref
fws1_prior_ref = fedorov_wynn_stan_par(mean_log_det_stan, datastruct_prior_ma_3, inits_3, chosen_indices_prior, n_iter = 0)
fws1_noprior_ref = fedorov_wynn_stan_par(mean_log_det_stan, datastruct_noprior_ma_3, inits_3, chosen_indices_noprior, n_iter = 0)
fws2_prior_ref = fedorov_wynn_stan_par(mean_log_det_stan, datastruct_prior_ma_3, inits_3, chosen_indices_prior, n_iter = 0)
fws2_noprior_ref = fedorov_wynn_stan_par(mean_log_det_stan, datastruct_noprior_ma_3, inits_3, chosen_indices_noprior, n_iter = 0)

chosen_indices_prior   = c(209,212) # p=2
fws1_prior_2 = fedorov_wynn_stan_par(mean_log_det_stan, datastruct_prior_ma_3, inits_3, chosen_indices_prior, n_iter = 0)
chosen_indices_prior   = c(213,214) # p=2
fws2_prior_2 = fedorov_wynn_stan_par(mean_log_det_stan, datastruct_prior_ma_3, inits_3, chosen_indices_prior, n_iter = 0)

chosen_indices_prior   = c(210,209,79) # p=3
chosen_indices_noprior = c(210,209,79) # p=3
fws1_prior_3 = fedorov_wynn_stan_par(mean_log_det_stan, datastruct_prior_ma_3, inits_3, chosen_indices_prior, n_iter = 0)
fws1_noprior_3 = fedorov_wynn_stan_par(mean_log_det_stan, datastruct_noprior_ma_3, inits_3, chosen_indices_noprior, n_iter = 0)
chosen_indices_prior   = c(214,209,215) # p=3
chosen_indices_noprior = c(214,211,63) # p=3
fws2_prior_3 = fedorov_wynn_stan_par(mean_log_det_stan, datastruct_prior_ma_3, inits_3, chosen_indices_prior, n_iter = 0)
fws2_noprior_3 = fedorov_wynn_stan_par(mean_log_det_stan, datastruct_noprior_ma_3, inits_3, chosen_indices_noprior, n_iter = 0)

chosen_indices_prior   = c(209,210,215,79) # p=4
chosen_indices_noprior = c(209,210,215,71) # p=4
fws1_prior_4 = fedorov_wynn_stan_par(mean_log_det_stan, datastruct_prior_ma_3, inits_3, chosen_indices_prior, n_iter = 0)
fws1_noprior_4 = fedorov_wynn_stan_par(mean_log_det_stan, datastruct_noprior_ma_3, inits_3, chosen_indices_noprior, n_iter = 0)
chosen_indices_prior   = c(209,212,215,216) # p=4
chosen_indices_noprior = c(209,214,215,63) # p=4
fws2_prior_4 = fedorov_wynn_stan_par(mean_log_det_stan, datastruct_prior_ma_3, inits_3, chosen_indices_prior, n_iter = 0)
fws2_noprior_4 = fedorov_wynn_stan_par(mean_log_det_stan, datastruct_noprior_ma_3, inits_3, chosen_indices_noprior, n_iter = 0)

chosen_indices_prior = c(210,209,212,215,79) # p=5
chosen_indices_noprior = c(210,209,212,215,71) # p=5
fws1_prior_5 = fedorov_wynn_stan_par(mean_log_det_stan, datastruct_prior_ma_3, inits_3, chosen_indices_prior, n_iter = 0)
fws1_noprior_5 = fedorov_wynn_stan_par(mean_log_det_stan, datastruct_noprior_ma_3, inits_3, chosen_indices_noprior, n_iter = 0)
chosen_indices_prior = c(207,209,212,215,216) # p=5
chosen_indices_noprior = c(216,209,212,215,63) # p=5
fws2_prior_5 = fedorov_wynn_stan_par(mean_log_det_stan, datastruct_prior_ma_3, inits_3, chosen_indices_prior, n_iter = 0)
fws2_noprior_5 = fedorov_wynn_stan_par(mean_log_det_stan, datastruct_noprior_ma_3, inits_3, chosen_indices_noprior, n_iter = 0)

summary_results_diff = tibble(logP = logP3,
                          Type = NAB3,
                          fws1_prior_ref = fws1_prior_ref$log_det_FIM,
                          fws1_noprior_ref = fws1_noprior_ref$log_det_FIM,
                          fws1_prior_2 = fws1_prior_2$log_det_FIM,
...
p2=ggplot(summary_results_diff, aes(y=method,x=exp(value)))+
  ...
  geom_jitter(aes(y=method, x=exp(value), color=logP),size=0.5, alpha=0.1)+
  scale_color_continuous(type="viridis")+
  labs(x=" Efficiency of designs (optimzed for maxtg = 30 and based on maxtg = 270)", y = "Method")+
  geom_vline(xintercept = 1, linetype = "dotted")
```
...
my.ggsave(.plot=p2, .filename=paste("single-form-analytes-logdFIM-test.pdf"), .path = figures_dir)
my.ggsave.png(.plot=p2, .filename=paste("single-form-analytes-logdFIM-test.png"), .path = figures_dir)
